                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control col-sm-9" value="<?= $hasil['no_plat'];?>" name="no_plat" placeholder="Isi Seri Produk">
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3">Merk Produk</label>
                                <input type="text" class="form-control col-sm-9"  value="<?= $hasil['merk'];?>" name="merk" placeholder="Isi Merk Produk">
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3">Harga Sewa</label>
                                <input type="text" class="form-control col-sm-9"  value="<?= $hasil['harga'];?>" name="harga" placeholder="Isi Harga Sewa">
                            </div>
