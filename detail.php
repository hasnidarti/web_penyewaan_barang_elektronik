<?php
/*
  | Source Code Aplikasi penyewaan elektronikPHP & MySQL
  | 
  | 
  | 
  | 
 */
    ...
    $hasil = $koneksi->query("SELECT * FROM elektronik WHERE id_elektronik = '$id'")->fetch();
?>
    ...
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body">
                ...
                <hr/>
                <center>
                    <a href="booking.php?id=<?php echo $hasil['id_elektronik'];?>" class="btn btn-success">Booking now!</a>
